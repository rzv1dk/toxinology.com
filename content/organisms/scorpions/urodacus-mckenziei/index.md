---
id: "urodacus-mckenziei"
title: "Urodacus mckenziei"
scientific_name: "Urodacus mckenziei"
aliases: []
topic: "organisms"
subject: "scorpions"
risk: "Unknown Risk"
countries: ["Australia"]
keywords: ["scorpions","Unknown Risk","Scorpionidae","Urodacus","mckenziei"]
...
tags: ["category:scorpions","Scorpionidae","Urodacus","mckenziei","country:Australia","keyword:scorpions","keyword:Unknown Risk","keyword:Scorpionidae","keyword:Urodacus","keyword:mckenziei","diagnostic:Localised Effects at bite/string/contact location","diagnostic:Effects on Red Blood Cells (potentially including haemolysis)"]
image_sources: ["http://www.toxinology.com/images/scorpions/SCML1424.gif","http://www.toxinology.com/images/scorpions/SCML1424.gif"]
...
Insufficient clinical reports to know, but likely to cause short lived local effects only, most unlikely to cause fatality

Based on information currently available to us, it appears this scorpion is unlikely to cause significant envenoming. Larger specimens or species may deliver larger quantities of venom when they sting, but scorpion toxicity is not based on scorpion size.

In general, expect stings by these scorpions to cause local effects only, varying from minor pain, to severe local pain of short duration. Some associated local redness or swelling might develop. Local tissue injury is not expected. Systemic effects are not expected, though it is possible some minor general effects such as headache might develop in a few cases.

Should a patient develop major local or systemic effects, recheck the identity of the scorpion. Given the paucity of clinical information available about most scorpion species, we cannot guarantee every sting will follow the pattern listed above.
...
Carapace is yellow to reddish yellow with eyes surrounded with black. Tergites are yellowish to reddish yellow with a variably distinct darker median band. Metasomal segments are usually slightly darker than mesosoma and more yellowish brown. Pedipalps are reddish yellow with keels marked with darker pigment and finger darker reddish yellow.Ventral surface and sternites are pale yellowish brown. Legs are pale yellowish brown with reddish to reddish brown articulation spots. Chelicerae yellowish.

### Taxonomy Synonomy

Urodacus mckenziei, Volschenk, Harvey and Smith, 2000.
...
Australia ( Carnarvon, Shark Bay region of Western Australia ).
...
Volschenk E.S., Smith G.T. and Harvey M.S. (2000) A new species of Urodacus from Western Australia, with additional descriptive notes for Urodacus magamastigus (Scorpiones). Rec. West. Aust. Mus., Vol. 20(1), pp 57-67.
...
Source: http://www.toxinology.com/images/scorpions/SCML1424.gif
